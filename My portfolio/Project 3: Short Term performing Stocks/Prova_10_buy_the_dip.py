...
def data_mining():
    df=pd.read_csv('/Users/giuseppelecca/Desktop/Project_1 best performing stocks/stocks26-03-2021.csv', index_col=0, parse_dates=True)
...
def find_top():
    ...
    csv=df.tail().to_csv(r'/Users/giuseppelecca/Desktop/Project_1 best performing stocks/Tickers26-03-2021.csv')
    df_2=data_mining()
